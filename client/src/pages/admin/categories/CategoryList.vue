        ...
        <div class="admin-content">
            ...
            <div class="admin-content__table">
                <div class="admin-content__header d-flex align-items-center">
                    <router-link v-show="!isTrashRoute" to="/admin/category" class="admin-content__title-link">
                        <h4>Tất cả danh mục</h4>
                    </router-link>
                    <router-link v-show="isTrashRoute" to="/admin/category/trash" class="admin-content__title-link">
                ...
                <CheckboxTable ref="checkboxTable" :items="categories" @update:ids="handleUpdateIds">
                    <template #header>
                        <th scope="col">ID
                    ...
                    <template #body="{ item }">
                        ...
                        <td>
                            <template v-if="!isTrashRoute">
                                <router-link :to="'/admin/category/edit/' + item.id" class="fs-16 btn btn-primary">Sửa</router-link>&nbsp;
