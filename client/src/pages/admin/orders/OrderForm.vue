                ...
                <div class="admin-content__form">
                    ...
                    <div class="admin-content__form-body">
                        <div class="admin-content__form-divided">
                            <div class="mb-20">
                                ...
                                <div class="valid-elm input-group">
                                    <input type="text" class="fs-16 form-control" v-model="order.id">
                                </div>
                            </div>
                            <div class="mb-20">
                                <h3 class="admin-content__form-text">Mã tài khoản đặt hàng</h3>
                                <div class="valid-elm input-group">
                                    <input type="text" class="fs-16 form-control" v-model="order.user_id">
                                </div>
                            </div>
                        </div>
                        <div class="admin-content__form-divided">
                            <div class="mb-20">
                                ...
                                <div class="valid-elm input-group">
                                    <input type="text" class="fs-16 form-control" v-model="order.name">
                                </div>
                            </div>
                            <div class="mb-20">
                                <h3 class="admin-content__form-text">Số điện thoại</h3>
                                <div class="valid-elm input-group">
                                    <input type="text" class="fs-16 form-control" v-model="order.phone">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-20 height-105">
                            ...
                            <div class="valid-elm input-group">
                                <textarea class="fs-16 form-control" rows="3" placeholder="Nhập địa chỉ" v-model="order.shipping_address"></textarea>
                            </div>
                        </div>
                        <div class="mb-20">
                            <h3 class="admin-content__form-text">Loại địa chỉ</h3>
                            <div class="valid-elm input-group">
                                <input type="text" class="fs-16 form-control" placeholder="Nhập loại địa chỉ" v-model="order.address_type">
                            </div>
                        </div>
                        <div class="admin-content__form-divided-3">
                            <div class="mb-20">
                                ...
                                <div class="valid-elm input-group">
                                    <input type="number" class="fs-16 form-control" placeholder="Nhập tiền hàng" v-model="order.product_total">
                                </div>
                            </div>
                            <div class="mb-20">
                                <h3 class="admin-content__form-text">Phí vận chuyển</h3>
                                <div class="valid-elm input-group">
                                    <input type="number" class="fs-16 form-control" placeholder="Nhập phí vận chuyển" v-model="order.shipping_fee">
                                </div>
                            </div>
                            <div class="mb-20">
                                <h3 class="admin-content__form-text">Giảm giá (nếu có)</h3>
                                <div class="valid-elm input-group">
                                    <input type="text" class="fs-16 form-control" placeholder="Nhập giảm giá" :value="order.voucher ? order.voucher.value + ' (' + order.voucher.code + ')' : '0'">
                                </div>
                            </div>
                        </div>
                        <div class="mb-20">
                            ...
                            <div class="valid-elm input-group">
                                <input type="number" class="fs-16 form-control" placeholder="Nhập tổng tiền" v-model="order.total_amount">
                            </div>
                        </div>
                        <div class="admin-content__form-divided">
                            <div class="mb-20">
                                ...
                                <div class="valid-elm input-group">
                                    <input type="text" class="fs-16 form-control" placeholder="Nhập phương thức thanh toán" v-model="order.payment_method">
                                </div>
                            </div>
                            <div class="mb-20">
                        ...
                        <div class="admin-content__form-divided">
                            ...
                            <div class="mb-20">
                                ...
                                <div class="valid-elm input-group">
                                    <input type="text" class="fs-16 form-control" :value="order.approver?.name">
                                </div>
                            </div>
                        </div>
                        <div class="admin-content__form-divided">
                            <div class="mb-20">
                                ...
                                <div class="valid-elm input-group">
                                    <input type="text" class="fs-16 form-control" :value="formatDate(order.created_at)">
                                </div>
                            </div>
                            <div class="mb-20">
                                <h3 class="admin-content__form-text">Cập nhật lần cuối</h3>
                                <div class="valid-elm input-group">
                                    <input type="text" class="fs-16 form-control" :value="formatDate(order.updated_at)">
                                </div>
                            </div>
                        </div>
                        <div class="admin-content__form-divided-3">
                            <div class="mb-20">
                                ...
                                <div class="valid-elm input-group">
                                    <input type="text" class="fs-16 form-control" :value="formatDate(order.shipped_at)">
                                </div>
                            </div>
                            <div class="mb-20">
                                <h3 class="admin-content__form-text">Ngày nhận hàng</h3>
                                <div class="valid-elm input-group">
                                    <input type="text" class="fs-16 form-control" :value="formatDate(order.completed_at)">
                                </div>
                            </div>
                            <div class="mb-20">
                                <h3 class="admin-content__form-text">Ngày hủy đơn</h3>
                                <div class="valid-elm input-group">
                                    <input type="text" class="fs-16 form-control" :value="formatDate(order.cancelled_at)">
                                </div>
                            </div>
                        </div>
                        <div class="mb-20 height-105">
                            ...
                            <div class="valid-elm input-group">
                                <textarea class="fs-16 form-control" rows="3" placeholder="Nhập lý do hủy đơn" v-model="order.cancel_reason"></textarea>
                            </div>
                        </div>
...
export default {
    ...
    methods: {
        ...
        async onUpdateStatus(id, status) {
            ...
            try {
                const res = await apiService.orders.updateStatus(id, status);
        ...
        async fetchData() {
            try {
                const res = await this.$swal.withLoading(apiService.orders.getOne(this.$route.params.id));
                this.order = res.data;
