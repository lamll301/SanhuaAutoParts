...
export default {
    ...
    methods: {
        ...
        async onRestore(id) {
            await handleApiCall(() => this.$request.patch(apiService.suppliers.restore(id)));
        ...
        async onForceDelete(id) {
            ...
            await handleApiCall(() => this.$request.delete(apiService.suppliers.forceDelete(id)));
        ...
        async handleFormActions() {
            ...
            await handleApiCall(() => this.$request.post(apiService.suppliers.handleActions(), {
                action,
